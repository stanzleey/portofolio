        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h4>Edit Keahlian: {{ $keahlian->nama }}</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.keahlian.update', $keahlian->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama') is-invalid @enderror" 
                                   id="nama" name="nama" value="{{ old('nama', $keahlian->nama) }}" required>
                            @error('nama')
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control @error('persentase') is-invalid @enderror" 
                                       id="persentase" name="persentase" value="{{ old('persentase', $keahlian->persentase) }}" 
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control @error('last_week_percent') is-invalid @enderror" 
                                       id="last_week_percent" name="last_week_percent" 
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control @error('last_month_percent') is-invalid @enderror" 
                                       id="last_month_percent" name="last_month_percent" 
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('urutan') is-invalid @enderror" 
                                   id="urutan" name="urutan" value="{{ old('urutan', $keahlian->urutan) }}" min="0">
                            @error('urutan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
